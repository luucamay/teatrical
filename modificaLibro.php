...
//modificando de libro
$sql = "UPDATE libro SET pais='$pais', editorial='$editorial', fecha_publicacion='$fecha_publicacion' WHERE cod_item = '$cod_item';";
    $retval = mysql_query( $sql);
    if(! $retval )
    {
      die('Could not modify data: ' . mysql_error());
    }
    echo '<br/>'."Modified libro successfully".'<br/>';    
