...
<div class="col-9 col-m-9">
    <div class="panel" id="modificar">
        ...
        <form method="post" name="modificar" action="modificaRevista.php" enctype="multipart/form-data">          
            <input type="text" name="datoant" value="Revista a modificar" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Revista a modificar';}" required/>
            ...
            <button type="button" onclick="window.location.href='mrevistas.php';">Volver</button>
