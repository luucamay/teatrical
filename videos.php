        ...
        <div id="content">
        	  ...
        	  <div class="scrollContainer">
                  <div class="panel" id="videos">
                    ...
                    echo '<tr><th>cod</th><th>nombre</th><th>duracion</th><th>locacion</th><th>fecha creacion</th><th>Ver archivo</th></tr>';
                    while ($row = mysql_fetch_array($result, MYSQL_NUM)) {
                        ...
                        echo "<td> $row[3] </td>";
                        echo "<td> $row[4] </td>";
                        echo "<td style='text-align: center'><a href=$row[5] target='_blank'><img src='images/play.png' alt='play' rel='nofollow' class='icon'/></a></td>";
                        echo "</tr>";
                    }
                    echo "</table>\n";
                    // Liberar resultados
                ...
                <div class="panel" id="adicionar">
                    ...
                    <tr>
                    <td><label for="locacion">Locacion:</label></td>
                    <td><input type="text" name="locacion" class="input_field" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    <td colspan="2"><ul class="boton float_r"><li><a href="videos.php">Volver</a></li></ul></td>
                    </tr>
                </table>
                </form>
                ...
                <div class="panel" id="modificar">
                    ...
                    <table>
                    <tr>
                    <td colspan="2"><label for="datoant">Video a modificar:</label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    <td><label for="locacion">Locacion:</label></td>
                    <td><input type="text" name="locacion" class="input_field" placeholder="Nueva locacion"/></td>
                    </tr>
                    <tr>
                    <td><label for="fecha_creacion">Fecha de creacion:</label></td>
                    <td><input type="text" name="fecha_creacion" class="input_field" /></td>
                    ...
                    <tr>
                    <td><input type="submit" class="submit_btn float_l" name="modificar" value="Modificar Video"/></td>
                    <td><input type="reset" class="submit_btn float_r" name="reset" id="reset" value="Reset"/></td>
                    </tr>
                    </tr>
                    <tr>
                ...
                <div class="panel" id="eliminar">
                    ...
                    <div class="cleaner h30"></div>
                    <div class="formulario">
                    <form method="post" name="eliminar" action="deleteVideo.php" enctype="multipart/form-data">
                    <table>
                    <tr>
                    <td><label for="nombre">Nombre:</label></td>
                    <td><input type="text" name="nombre" class="input_field" required/></td>
                    ...
                    <tr>
                    <td><input type="submit" class="submit_btn float_l" name="delete" value="Eliminar Video"/></td>
                    <td><input type="reset" class="submit_btn float_r" name="reset" id="reset" value="Reset"/></td>
                    </tr>
                    </tr>
                    <tr>
