...
<div id="audios">
    ...
    <div class="aside">
    <ul>
      <li><a href="faadicionar.php">Adicionar</a></li>
      <li><a href="famodificar.php">Modificar</a></li>
      <li><a href="faeliminar.php">Eliminar</a></li>
    </ul>
    </div>
...
?>
    ...
    <div class="float_l element">
        ...
        <div class="float_l">
            <a href=<?php echo $row[4];?> target='_blank'><img src='images/play.png' alt='pdf Imagen' rel='nofollow' class='icon'/></a>    
        </div>
    </div>
